...
cp %{_builddir}/Log-Dispatch-FileRotate-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Log-Dispatch-FileRotate/bab88f54ea8c7c2588e407bd69fad8bf7cb47c1b || :
if test -f Makefile.PL; then
